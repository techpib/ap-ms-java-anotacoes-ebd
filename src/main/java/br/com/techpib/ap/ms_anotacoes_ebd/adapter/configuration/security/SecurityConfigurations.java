...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/ap-anotacoes-ebd/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/ap-anotacoes-ebd/anotacao").permitAll()
                .antMatchers(HttpMethod.DELETE, "/ap-anotacoes-ebd/anotacao").permitAll()
